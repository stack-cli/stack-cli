...
const SECRET_TUNNEL_NAME_KEY: &str = "tunnel_name";
const SECRET_INGRESS_TARGET_KEY: &str = "ingress_target";
...
pub async fn deploy(
    ...
    if let Some(secret_name) = secret_name {
        ...
        let tunnel_name = read_secret_field(&secret, SECRET_TUNNEL_NAME_KEY)
            .ok_or_else(|| Error::Other("Cloudflare secret missing tunnel_name".to_string()))?;
        ...
        let yaml = CLOUDFLARE_CONFIG_YAML
