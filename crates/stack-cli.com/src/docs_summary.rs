            ...
            Category {
                ...
                pages: vec![
                    ...
                    Page {
                        ...
                        description: "Supabase Auth (GoTrue) for your apps",
                    ...
                    Page {
                        date: "",
                        title: "OIDC (Keycloak)",
                        description: "Keycloak and OAuth2 Proxy for protected routes",
                        folder: "docs/oidc/",
                        markdown: include_str!("../content/docs/oidc/index.md"),
                        image: None,
                        author_image: None,
                        author: None,
                    },
